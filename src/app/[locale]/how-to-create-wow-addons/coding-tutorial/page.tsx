...
export async function generateMetadata({ params }: { params: Promise<{ locale: Locale }> }): Promise<Metadata> {
  ...
  return generatePageSEO({
    ...
    canonical: `https://www.customwowaddon.com/${locale}/how-to-create-wow-addons/coding-tutorial`,
    datePublished: "2026-03-28T12:00:00Z",
  });
}

export default async function CodingTutorial({ params }: { params: Promise<{ locale: Locale }> }) {
  const { locale } = await params;
      ...
      <Script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify(generateArticleSchema({
            title: "Step-by-Step Tutorial: Writing Your First Addon",
            description: "A technical masterclass. Build a World of Warcraft addon from absolute scratch using TOC files and raw Lua code.",
            url: `${SITE_URL}/${locale}/how-to-create-wow-addons/coding-tutorial`,
            datePublished: "2026-03-28T12:00:00Z",
          })),
        }}
      />
      <Script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify(generateBreadcrumbSchema([
            ...
            { name: "Coding Tutorial", url: `${SITE_URL}/${locale}/how-to-create-wow-addons/coding-tutorial` },
          ])),
        }}
      />
